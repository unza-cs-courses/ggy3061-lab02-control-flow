#!/usr/bin/env python3
"""
Deterministic Variant Computation - Lab 2: Control Flow
...
def generate_parameters(rng, group_id):
    ...
    return {
        ...
        'test_samples': [round(rng.uniform(-0.5, 5.0), 1) for _ in range(8)],
        'drilling_depths': [rng.randint(100, 1200) for _ in range(4)],
        'base_rate': rng.choice([45, 50, 55, 60, 65, 70, 75]),
    }
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("YOUR ASSIGNMENT VALUES - Lab 2: Control Flow")
    print("=" * 60)
